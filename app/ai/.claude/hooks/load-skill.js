...
//
// - NATIVE_SKILL is loaded (once per session) when set. Currently null because
//   no AI-specific skill is maintained yet (kept for parity with backend/frontend
//   workspace hooks so adding one later is a one-line change).

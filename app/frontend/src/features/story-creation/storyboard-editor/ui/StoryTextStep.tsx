    ...
    <div className="bookshelf-modal step-forest-modal">
      ...
      <div className="flex items-center justify-between py-4 px-8 border-b border-[#4a3a24] bg-[#2a1b12]/60 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <span className="text-[#b4c4a4] text-base font-bold tracking-wider">STEP 03 / 08</span>
          <span className="bookshelf-title-display text-3xl text-[#f0e6c0] font-bold">스토리 구성하기</span>
        </div>
      </div>
          ...
          <div className="max-w-3xl mx-auto pb-12">
            ...
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 bg-[#2d5a27]/60 px-4 py-1.5 rounded-full border border-[#b4dc8c]/50 mb-4 shadow-sm">
                ...
                <span className="text-[#b4dc8c] text-base font-bold">AI가 이야기를 만들었어요</span>
              </div>
              <h1 className="text-4xl md:text-5xl text-[#f0e6c0] mb-3 font-bold">
                우리 가족의 특별한 줄거리
              </h1>
              <p className="text-[#b4c4a4] text-xl">
                전체적인 흐름이 마음에 드시나요?
                <br />
            ...
            <div className="bg-[#f0e6c0] rounded-[2.5rem] border-2 border-[#2a1b12] shadow-[0_20px_60px_rgba(0,0,0,0.5)] overflow-hidden mb-8">
              <div className="p-6 md:p-10">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-3xl text-[#2d5a27] flex items-center gap-2 font-bold">
                    <BookOpenCheck className="w-7 h-7" />
                    동화책 줄거리 요약
                  </h2>
                  <span className="text-[#8b7a52] text-base font-sans">약 {data.story.length}자</span>
                </div>
                ...
                <textarea
                  ...
                  className="w-full h-64 p-6 rounded-2xl bg-[#e8ddb4] border-2 border-[#8b7a52]/60 text-[#2d5a27] text-xl leading-relaxed focus:border-[#2d5a27] focus:ring-4 focus:ring-[#b4dc8c]/30 focus:outline-none resize-none font-sans"
                />

                <div className="mt-4 flex justify-end">
                  <p className="text-[#8b7a52] text-base flex items-center gap-1">
              ...
              <div className="bg-[#e8ddb4] p-6 md:p-8 border-t-2 border-[#8b7a52]/40">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 p-4 rounded-xl border-2 border-[#b4dc8c] bg-[#f0e6c0] focus:border-[#2d5a27] focus:outline-none text-xl font-sans text-[#2d5a27] placeholder-[#8b7a52]/60"
                  />
                  <button
                    type="button"
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {REFINE_QUICK_TAGS.map(t => (
                    <button
                      ...
                      className="px-3 py-1.5 bg-[#f0e6c0] border-2 border-[#b4dc8c] rounded-full text-base text-[#2d5a27] hover:bg-[#2d5a27] hover:text-[#f0e6c0] font-bold transition-colors shadow-sm"
                    >
                      {t.emoji} {t.text}
                    </button>
                  ))}
            ...
            <div className="flex justify-between items-center pt-6 border-t border-[#4a3a24]">
              ...
              <button
                type="button"
                onClick={onNext}
                className="bg-[#2d5a27] text-[#f0e6c0] px-10 py-4 rounded-full border border-[#b4dc8c]/40 shadow-[0_4px_0_#1a3a14,0_0_20px_rgba(180,220,140,0.25)] hover:translate-y-1 hover:shadow-[0_2px_0_#1a3a14,0_0_30px_rgba(180,220,140,0.5)] hover:bg-[#3d6f34] transition-all font-bold flex items-center gap-2 text-2xl whitespace-nowrap"
              >

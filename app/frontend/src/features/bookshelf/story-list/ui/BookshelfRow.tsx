...
export function BookshelfRow({
  ...
  return (
    <div className="relative w-full px-2 sm:px-6 pt-6">
      {/* 원목 선반 윗면 */}
      <div className="absolute bottom-0 left-0 w-full h-14 bg-[#b57a4c] wood-texture rounded-t-sm z-10 overflow-hidden" />
      {/* 선반 앞면 */}
      <div className="absolute top-full left-0 w-full h-8 bg-[#6a4225] wood-texture border-t border-[#4f2d15] shadow-[0_20px_25px_-5px_rgba(0,0,0,0.5)] rounded-b-md z-10" />
      {/* 철제 브래킷 */}

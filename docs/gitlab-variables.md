...
- [ ] `ENV_DEV_APP_AWS_ACCESS_KEY_ID` — Variable · **Masked ✅** · `s210-backend-s3` IAM user Access Key ID
- [ ] `ENV_DEV_APP_AWS_SECRET_ACCESS_KEY` — Variable · **Masked ✅** · `s210-backend-s3` IAM user Secret Access Key
- [ ] `ENV_DEV_APP_AWS_REGION` — Variable — `ap-northeast-2`
- [ ] `ENV_DEV_APP_AWS_S3_BUCKET` — Variable — `s210-iportfolio-dev` (사용자 사진 + 생성 이미지 저장 버킷)
...
- [ ] `ENV_MASTER_APP_AWS_SECRET_ACCESS_KEY` — Variable · **Masked ✅** · **Protected ✅**
- [ ] `ENV_MASTER_APP_AWS_REGION` — Variable · **Protected ✅** — `ap-northeast-2`
- [ ] `ENV_MASTER_APP_AWS_S3_BUCKET` — Variable · **Protected ✅** — prod 전용 버킷명 (MVP 엔 dev 버킷 공유 허용, 분리 권장)
